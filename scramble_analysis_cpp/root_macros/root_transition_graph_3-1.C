...
// By ROOT version 6.05/03 on 2015-10-15 11:02:08
...
void root_transition_graph_3-1()
{
   ...
   TGListTreeItem *item0 = fListTree1091->AddItem(NULL,"root");
   ...
   fListTree1091->CloseItem(item0);
   TGListTreeItem *item1 = fListTree1091->AddItem(NULL,"PROOF Sessions");
   item1->SetPictures(popen, pclose);
   item1->SetTipText("Proofs\nDoubly linked list");
   fListTree1091->CloseItem(item1);
   TGListTreeItem *item2 = fListTree1091->AddItem(NULL,"ROOT Files");
   item2->SetPictures(popen, pclose);
   item2->SetTipText("Files\nDoubly linked list");
   fListTree1091->OpenItem(item2);
   TGListTreeItem *item3 = fListTree1091->AddItem(item2,"root_longest_chain.root");
   popen = gClient->GetPicture("rootdb_t.xpm__16x16");
   pclose = gClient->GetPicture("rootdb_t.xpm__16x16");
   item3->SetPictures(popen, pclose);
   item3->SetTipText("root_longest_chain.root\n");
   TGListTreeItem *item4 = fListTree1091->AddItem(item2,"root_transition_analysis.root");
   item4->SetPictures(popen, pclose);
   item4->SetTipText("root_transition_analysis.root\n");
   TGListTreeItem *item5 = fListTree1091->AddItem(NULL,"/");
   popen = gClient->GetPicture("ofolder_t.xpm");
   pclose = gClient->GetPicture("folder_t.xpm");
   item5->SetPictures(popen, pclose);
   fListTree1091->OpenItem(item5);
   TGListTreeItem *item6 = fListTree1091->AddItem(item5,"home");
   item6->SetPictures(popen, pclose);
   TGListTreeItem *item7 = fListTree1091->AddItem(item6,"velo");
   item7->SetPictures(popen, pclose);
   TGListTreeItem *item8 = fListTree1091->AddItem(item7,"Desktop");
   item8->SetPictures(popen, pclose);
   TGListTreeItem *item9 = fListTree1091->AddItem(item7,"Documents");
   item9->SetPictures(popen, pclose);
   TGListTreeItem *item10 = fListTree1091->AddItem(item9,"B_N_T");
   item10->SetPictures(popen, pclose);
   TGListTreeItem *item11 = fListTree1091->AddItem(item10,"new_scrambler");
   item11->SetPictures(popen, pclose);
   TGListTreeItem *item12 = fListTree1091->AddItem(item10,"new_scrambler_resource_analysis");
   item12->SetPictures(popen, pclose);
   TGListTreeItem *item13 = fListTree1091->AddItem(item10,"new_scrambler_resource_analysis_backup");
   item13->SetPictures(popen, pclose);
   TGListTreeItem *item14 = fListTree1091->AddItem(item10,"new_scrambler_transitions_vhdl");
   item14->SetPictures(popen, pclose);
   TGListTreeItem *item15 = fListTree1091->AddItem(item10,"old_scrambler_resource_analysis");
   item15->SetPictures(popen, pclose);
   TGListTreeItem *item16 = fListTree1091->AddItem(item10,"old_scrambler_transitions_vhdl");
   item16->SetPictures(popen, pclose);
   TGListTreeItem *item17 = fListTree1091->AddItem(item10,"resources");
   item17->SetPictures(popen, pclose);
   TGListTreeItem *item18 = fListTree1091->AddItem(item10,"scramble_analysis_cpp");
   item18->SetPictures(popen, pclose);
   TGListTreeItem *item19 = fListTree1091->AddItem(item18,"#root_transition_analysis.h#");
   popen = gClient->GetPicture("doc_t.xpm");
   pclose = gClient->GetPicture("doc_t.xpm");
   item19->SetPictures(popen, pclose);
   item19->SetTipText("#root_transition_analysis.h#\nSize: 1.5K\n2015-10-14 15:20");
   TGListTreeItem *item20 = fListTree1091->AddItem(item18,"Longest_Chain_Hist.pdf");
   popen = gClient->GetPicture("pdf.xpm__16x16");
   pclose = gClient->GetPicture("pdf.xpm__16x16");
   item20->SetPictures(popen, pclose);
   item20->SetTipText("Longest_Chain_Hist.pdf\nSize: 14.0K\n2015-10-14 16:50");
   TGListTreeItem *item21 = fListTree1091->AddItem(item18,"Makefile");
   popen = gClient->GetPicture("doc_t.xpm");
   pclose = gClient->GetPicture("doc_t.xpm");
   item21->SetPictures(popen, pclose);
   item21->SetTipText("Makefile\nSize: 956\n2015-10-14 15:41");
   TGListTreeItem *item22 = fListTree1091->AddItem(item18,"Makefile~");
   item22->SetPictures(popen, pclose);
   item22->SetTipText("Makefile~\nSize: 662\n2015-10-14 13:12");
   TGListTreeItem *item23 = fListTree1091->AddItem(item18,"analysis_output.txt");
   item23->SetPictures(popen, pclose);
   TGListTreeItem *item24 = fListTree1091->AddItem(item18,"desyncFilter.txt");
   item24->SetPictures(popen, pclose);
   item24->SetTipText("desyncFilter.txt\nSize: 1.6M\n2015-10-14 11:24");
   TGListTreeItem *item25 = fListTree1091->AddItem(item18,"draw_transition_graph.C");
   popen = gClient->GetPicture("macro_t.xpm__16x16");
   pclose = gClient->GetPicture("macro_t.xpm__16x16");
   item25->SetPictures(popen, pclose);
   item25->SetTipText("draw_transition_graph.C\nSize: 537\n2015-10-14 14:08");
   TGListTreeItem *item26 = fListTree1091->AddItem(item18,"draw_transition_graph.C~");
   popen = gClient->GetPicture("doc_t.xpm");
   pclose = gClient->GetPicture("doc_t.xpm");
   item26->SetPictures(popen, pclose);
   item26->SetTipText("draw_transition_graph.C~\nSize: 542\n2015-10-14 14:03");
   TGListTreeItem *item27 = fListTree1091->AddItem(item18,"in_check_file.txt");
   item27->SetPictures(popen, pclose);
   item27->SetTipText("in_check_file.txt\nSize: 1.6M\n2015-10-15 10:09");
   TGListTreeItem *item28 = fListTree1091->AddItem(item18,"new_scramble_output.txt");
   item28->SetPictures(popen, pclose);
   item28->SetTipText("new_scramble_output.txt\nSize: 1.6M\n2015-10-15 10:09");
   TGListTreeItem *item29 = fListTree1091->AddItem(item18,"old");
   item29->SetPictures(popen, pclose);
   item29->SetTipText("old\nSize: 13.0M\n2015-10-14 13:41");
   TGListTreeItem *item30 = fListTree1091->AddItem(item18,"old_scramble_output.txt");
   item30->SetPictures(popen, pclose);
   item30->SetTipText("old_scramble_output.txt\nSize: 1.6M\n2015-10-15 10:09");
   TGListTreeItem *item31 = fListTree1091->AddItem(item18,"root_longest_chain");
   item31->SetPictures(popen, pclose);
   item31->SetTipText("root_longest_chain\nSize: 25.1K\n2015-10-14 16:37");
   TGListTreeItem *item32 = fListTree1091->AddItem(item18,"root_longest_chain.cpp");
   ...
   item32->SetTipText("root_longest_chain.cpp\nSize: 1.8K\n2015-10-14 16:37");
   TGListTreeItem *item33 = fListTree1091->AddItem(item18,"root_longest_chain.cpp~");
   popen = gClient->GetPicture("doc_t.xpm");
   pclose = gClient->GetPicture("doc_t.xpm");
   item33->SetPictures(popen, pclose);
   item33->SetTipText("root_longest_chain.cpp~\nSize: 1.7K\n2015-10-14 15:20");
   TGListTreeItem *item34 = fListTree1091->AddItem(item18,"root_longest_chain.h");
   popen = gClient->GetPicture("h_src_t.xpm__16x16");
   pclose = gClient->GetPicture("h_src_t.xpm__16x16");
   item34->SetPictures(popen, pclose);
   item34->SetTipText("root_longest_chain.h\nSize: 1.5K\n2015-10-14 15:48");
   TGListTreeItem *item35 = fListTree1091->AddItem(item18,"root_longest_chain.h~");
   popen = gClient->GetPicture("doc_t.xpm");
   pclose = gClient->GetPicture("doc_t.xpm");
   item35->SetPictures(popen, pclose);
   item35->SetTipText("root_longest_chain.h~\nSize: 1.5K\n2015-10-14 14:57");
   TGListTreeItem *item36 = fListTree1091->AddItem(item18,"root_longest_chain.root");
   popen = gClient->GetPicture("rootdb_t.xpm__16x16");
   pclose = gClient->GetPicture("rootdb_t.xpm__16x16");
   item36->SetPictures(popen, pclose);
   item36->SetTipText("root_longest_chain.root\nSize: 4.6K\n2015-10-15 10:09");
   TGListTreeItem *item37 = fListTree1091->AddItem(item18,"root_transition_analysis");
   popen = gClient->GetPicture("doc_t.xpm");
   pclose = gClient->GetPicture("doc_t.xpm");
   item37->SetPictures(popen, pclose);
   item37->SetTipText("root_transition_analysis\nSize: 25.2K\n2015-10-14 16:37");
   TGListTreeItem *item38 = fListTree1091->AddItem(item18,"root_transition_analysis.cpp");
   popen = gClient->GetPicture("cpp_src_t.xpm__16x16");
   pclose = gClient->GetPicture("cpp_src_t.xpm__16x16");
   item38->SetPictures(popen, pclose);
   item38->SetTipText("root_transition_analysis.cpp\nSize: 2.2K\n2015-10-14 15:18");
   TGListTreeItem *item39 = fListTree1091->AddItem(item18,"root_transition_analysis.cpp~");
   popen = gClient->GetPicture("doc_t.xpm");
   pclose = gClient->GetPicture("doc_t.xpm");
   item39->SetPictures(popen, pclose);
   item39->SetTipText("root_transition_analysis.cpp~\nSize: 1.5K\n2015-10-14 14:57");
   TGListTreeItem *item40 = fListTree1091->AddItem(item18,"root_transition_analysis.h");
   popen = gClient->GetPicture("h_src_t.xpm__16x16");
   pclose = gClient->GetPicture("h_src_t.xpm__16x16");
   item40->SetPictures(popen, pclose);
   item40->SetTipText("root_transition_analysis.h\nSize: 1.6K\n2015-10-14 15:15");
   TGListTreeItem *item41 = fListTree1091->AddItem(item18,"root_transition_analysis.h~");
   popen = gClient->GetPicture("doc_t.xpm");
   pclose = gClient->GetPicture("doc_t.xpm");
   item41->SetPictures(popen, pclose);
   item41->SetTipText("root_transition_analysis.h~\nSize: 1.5K\n2015-10-14 14:57");
   TGListTreeItem *item42 = fListTree1091->AddItem(item18,"root_transition_analysis.root");
   popen = gClient->GetPicture("rootdb_t.xpm__16x16");
   pclose = gClient->GetPicture("rootdb_t.xpm__16x16");
   item42->SetPictures(popen, pclose);
   item42->SetTipText("root_transition_analysis.root\nSize: 128.7K\n2015-10-15 10:09");
   TGListTreeItem *item43 = fListTree1091->AddItem(item42,"Un_Scramble;1");
   popen = gClient->GetPicture("doc_t.xpm");
   pclose = gClient->GetPicture("doc_t.xpm");
   item43->SetPictures(popen, pclose);
   item43->SetTipText("Un_Scramble\nGraph");
   TGListTreeItem *item44 = fListTree1091->AddItem(item42,"New_Scramble;1");
   item44->SetPictures(popen, pclose);
   item44->SetTipText("New_Scramble\nGraph");
   TGListTreeItem *item45 = fListTree1091->AddItem(item42,"Old_Scramble;1");
   item45->SetPictures(popen, pclose);
   item45->SetTipText("Old_Scramble\nGraph");
   TGListTreeItem *item46 = fListTree1091->AddItem(item42,"Un_Scramble_short;1");
   item46->SetPictures(popen, pclose);
   item46->SetTipText("Un_Scramble_short\nGraph");
   TGListTreeItem *item47 = fListTree1091->AddItem(item42,"New_Scramble_short;1");
   item47->SetPictures(popen, pclose);
   item47->SetTipText("New_Scramble_short\nGraph");
   TGListTreeItem *item48 = fListTree1091->AddItem(item42,"Old_Scramble_short;1");
   item48->SetPictures(popen, pclose);
   item48->SetTipText("Old_Scramble_short\nGraph");
   TGListTreeItem *item49 = fListTree1091->AddItem(item18,"scramble_analysis_pre_root.cpp");
   popen = gClient->GetPicture("cpp_src_t.xpm__16x16");
   pclose = gClient->GetPicture("cpp_src_t.xpm__16x16");
   item49->SetPictures(popen, pclose);
   item49->SetTipText("scramble_analysis_pre_root.cpp\nSize: 14.9K\n2015-10-14 11:24");
   TGListTreeItem *item50 = fListTree1091->AddItem(item18,"scramble_analysis_pre_root.h");
   popen = gClient->GetPicture("h_src_t.xpm__16x16");
   pclose = gClient->GetPicture("h_src_t.xpm__16x16");
   item50->SetPictures(popen, pclose);
   item50->SetTipText("scramble_analysis_pre_root.h\nSize: 4.5K\n2015-10-14 11:24");
   TGListTreeItem *item51 = fListTree1091->AddItem(item18,"scramble_sim");
   popen = gClient->GetPicture("doc_t.xpm");
   pclose = gClient->GetPicture("doc_t.xpm");
   item51->SetPictures(popen, pclose);
   item51->SetTipText("scramble_sim\nSize: 83.2K\n2015-10-14 16:37");
   TGListTreeItem *item52 = fListTree1091->AddItem(item18,"scramble_sim.cpp");
   popen = gClient->GetPicture("cpp_src_t.xpm__16x16");
   pclose = gClient->GetPicture("cpp_src_t.xpm__16x16");
   item52->SetPictures(popen, pclose);
   item52->SetTipText("scramble_sim.cpp\nSize: 14.9K\n2015-10-14 13:49");
   TGListTreeItem *item53 = fListTree1091->AddItem(item18,"scramble_sim.cpp~");
   popen = gClient->GetPicture("doc_t.xpm");
   pclose = gClient->GetPicture("doc_t.xpm");
   item53->SetPictures(popen, pclose);
   item53->SetTipText("scramble_sim.cpp~\nSize: 14.9K\n2015-10-14 11:24");
   TGListTreeItem *item54 = fListTree1091->AddItem(item18,"scramble_sim.h");
   popen = gClient->GetPicture("h_src_t.xpm__16x16");
   pclose = gClient->GetPicture("h_src_t.xpm__16x16");
   item54->SetPictures(popen, pclose);
   item54->SetTipText("scramble_sim.h\nSize: 4.2K\n2015-10-14 13:50");
   TGListTreeItem *item55 = fListTree1091->AddItem(item18,"scramble_sim.h~");
   popen = gClient->GetPicture("doc_t.xpm");
   pclose = gClient->GetPicture("doc_t.xpm");
   item55->SetPictures(popen, pclose);
   item55->SetTipText("scramble_sim.h~\nSize: 4.1K\n2015-10-14 11:24");
   TGListTreeItem *item56 = fListTree1091->AddItem(item18,"transition_chain.cpp");
   popen = gClient->GetPicture("cpp_src_t.xpm__16x16");
   pclose = gClient->GetPicture("cpp_src_t.xpm__16x16");
   item56->SetPictures(popen, pclose);
   item56->SetTipText("transition_chain.cpp\nSize: 1.6K\n2015-10-14 15:20");
   TGListTreeItem *item57 = fListTree1091->AddItem(item18,"transition_chain.h");
   popen = gClient->GetPicture("h_src_t.xpm__16x16");
   pclose = gClient->GetPicture("h_src_t.xpm__16x16");
   item57->SetPictures(popen, pclose);
   item57->SetTipText("transition_chain.h\nSize: 1.3K\n2015-10-14 15:40");
   TGListTreeItem *item58 = fListTree1091->AddItem(item10,"scramble_analysis_cpp_backup");
   popen = gClient->GetPicture("ofolder_t.xpm");
   pclose = gClient->GetPicture("folder_t.xpm");
   item58->SetPictures(popen, pclose);
   TGListTreeItem *item59 = fListTree1091->AddItem(item10,"change_log.txt");
   popen = gClient->GetPicture("doc_t.xpm");
   pclose = gClient->GetPicture("doc_t.xpm");
   item59->SetPictures(popen, pclose);
   TGListTreeItem *item60 = fListTree1091->AddItem(item10,"change_log.txt~");
   item60->SetPictures(popen, pclose);
   TGListTreeItem *item61 = fListTree1091->AddItem(item9,"Presentations");
   popen = gClient->GetPicture("ofolder_t.xpm");
   pclose = gClient->GetPicture("folder_t.xpm");
   item61->SetPictures(popen, pclose);
   TGListTreeItem *item62 = fListTree1091->AddItem(item9,"backup_script.sh");
   popen = gClient->GetPicture("doc_t.xpm");
   pclose = gClient->GetPicture("doc_t.xpm");
   item62->SetPictures(popen, pclose);
   TGListTreeItem *item63 = fListTree1091->AddItem(item9,"backup_script.sh~");
   item63->SetPictures(popen, pclose);
   TGListTreeItem *item64 = fListTree1091->AddItem(item7,"Downloads");
   popen = gClient->GetPicture("ofolder_t.xpm");
   pclose = gClient->GetPicture("folder_t.xpm");
   item64->SetPictures(popen, pclose);
   TGListTreeItem *item65 = fListTree1091->AddItem(item7,"Modelsim");
   item65->SetPictures(popen, pclose);
   TGListTreeItem *item66 = fListTree1091->AddItem(item7,"Music");
   item66->SetPictures(popen, pclose);
   TGListTreeItem *item67 = fListTree1091->AddItem(item7,"Pictures");
   item67->SetPictures(popen, pclose);
   TGListTreeItem *item68 = fListTree1091->AddItem(item7,"Public");
   item68->SetPictures(popen, pclose);
   TGListTreeItem *item69 = fListTree1091->AddItem(item7,"Templates");
   item69->SetPictures(popen, pclose);
   TGListTreeItem *item70 = fListTree1091->AddItem(item7,"Videos");
   item70->SetPictures(popen, pclose);
   TGListTreeItem *item71 = fListTree1091->AddItem(item7,"altera");
   item71->SetPictures(popen, pclose);
   TGListTreeItem *item72 = fListTree1091->AddItem(item7,"amc40firmware");
   item72->SetPictures(popen, pclose);
   TGListTreeItem *item73 = fListTree1091->AddItem(item7,"local_quartus");
   item73->SetPictures(popen, pclose);
   TGListTreeItem *item74 = fListTree1091->AddItem(item7,"mgc");
   item74->SetPictures(popen, pclose);
   TGListTreeItem *item75 = fListTree1091->AddItem(item7,"root");
   item75->SetPictures(popen, pclose);
   TGListTreeItem *item76 = fListTree1091->AddItem(item7,"rootSource");
   item76->SetPictures(popen, pclose);
   TGListTreeItem *item77 = fListTree1091->AddItem(item7,"root_source");
   item77->SetPictures(popen, pclose);
   TGListTreeItem *item78 = fListTree1091->AddItem(item7,"modelsim");
   popen = gClient->GetPicture("doc_t.xpm");
   pclose = gClient->GetPicture("doc_t.xpm");
   item78->SetPictures(popen, pclose);
   TGListTreeItem *item79 = fListTree1091->AddItem(item7,"transcript");
