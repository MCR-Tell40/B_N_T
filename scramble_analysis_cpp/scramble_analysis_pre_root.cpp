...
packet attach_chunk_to_packet(packet packet_in, chunk attachment, int chunk_no)
{
   packet packet_out;
   ...
   for (int i(0); i < 30; i++)
   packet_out[30*chunk_no+i] = attachment[i];
...
chunk new_scramble_TX(chunk TX_DATA_IN, int i)
{
  static chunk TX_FEEDBACK [4] = {0,0,0,0};
  chunk TX_DATA_OUT(0);
...
chunk new_scramble_RX(chunk RX_DATA_IN, int i)
{
    static chunk RX_FEEDBACK [4] = {0,0,0,0};
  chunk RX_DATA_OUT(0);
...
chunk  old_scramble_TX(chunk DATA_IN, int i)
{
  static chunk COMMON_FRAME_1_TX [4] = {7,7,7,7};
  static chunk COMMON_FRAME_2_TX [4] = {0,0,0,0};
  chunk DATA_OUT(0);
...
chunk  old_scramble_RX(chunk DATA_IN, int i)
{
    static chunk COMMON_FRAME_1_RX [4] = {7,7,7,7};
    static chunk COMMON_FRAME_2_RX [4] = {0,0,0,0};
